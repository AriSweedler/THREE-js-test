...
Pilot.prototype.updateHairs = function(){
	...
	for (var i=0; i<l; i++){
		...
		var hairwaveMax = 0.35;
		var hairwaveMin = 0.05;
		var hairwaveDelta = hairwaveMax - hairwaveMin;
		var wavelength = (hairwaveMax) - ((hairwaveDelta/l)*i);
		//35% @ i = 0
		//5% @ i = l
		h.scale.y = (1-wavelength) + Math.cos(this.angleHairs+i/3)*wavelength;
	}
